    ...
    <table cellspacing="0" class="woocommerce-grouped-product-list group_table">
        ...
        foreach ($grouped_products as $grouped_product_child) {
            ...
            if ($product_extra_label !== '') {
                $extra_label = '<div class="aro-single-product-extra-label">' . wp_kses_post(wpautop($product_extra_label)) . '</div>';
            }
            ...
            foreach ($grouped_product_columns as $column_id) {
                ...
                switch ($column_id) {
                    ...
                    case 'label':
                        ...
                        break;
                    case 'image':
                        $value = $grouped_product_child->get_image('woocommerce-thumbnails');
                        break;
                    default:
                        $value = '';
                        break;
