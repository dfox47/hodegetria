 ...
 * @since 1.0.0
 */
class Aro_Elementor_Language_Switcher extends Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Language Switcher', 'aro');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .aro-language-switcher span.title',
            ]
        );
        ...
        $this->add_control(
            'label_color',
            [
                'label' => esc_html__('Label Color', 'aro'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .aro-language-switcher .item > div i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_right',
            [
                'label' => esc_html__('Hover Right', 'aro'),
    ...
    {
        aro_language_switcher();
    }
}

$widgets_manager->register(new Aro_Elementor_Language_Switcher());
