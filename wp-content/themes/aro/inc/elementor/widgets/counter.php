...
class Aro_Elementor_Counter extends Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'suffix',
            [
                'label'       => __('Number Suffix', 'aro'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => __('Plus', 'aro'),
            ]
        );
        ...
        $this->add_control(
            'show_icon',
            [
                'label'     => __('Show Icon', 'aro'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => __('Show', 'aro'),
                'label_off' => __('Hide', 'aro'),
            ]
        );
        ...
        $this->add_control(
            'icon_select',
            [
                'label'     => __('Icon select', 'aro'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'use_icon',
                'options'   => [
                    'use_icon'  => __('Use Icon', 'aro'),
                    'use_image' => __('Use Image', 'aro'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'duration',
            [
                'label'   => __('Animation Duration', 'aro'),
                'type'    => Controls_Manager::NUMBER,
                'default' => 2000,
                'min'     => 100,
                'step'    => 100,
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label'     => __('Thousand Separator', 'aro'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'label_on'  => __('Show', 'aro'),
                'label_off' => __('Hide', 'aro'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __('Cool Number', 'aro'),
                'placeholder' => __('Cool Number', 'aro'),
            ]
        );
        ...
        $this->add_control(
            'sub_title',
            [
                'label'       => __('Sub Title', 'aro'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Sub Title', 'aro'),
            ]
        );
        ...
        $this->add_control(
            'description',
            [
                'label'       => __('Description', 'aro'),
                'type'        => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'placeholder' => __('Description...', 'aro'),
            ]
        );
        ...
        $this->add_control(
            'style_special2',
            [
                'label'        => esc_html__('Style border special', 'aro'),
                'type'         => Controls_Manager::SWITCHER,
                'prefix_class' => 'counter-special-border-',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Vertical Alignment', 'aro'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'top'      => __('Top', 'aro'),
                    'middle'   => __('Middle', 'aro'),
                    'bottom'   => __('Bottom', 'aro'),
                ],
                'default'      => 'top',
        ...
        $this->add_control(
            'border_color_effect',
            [
                'label'     => esc_html__('Border Color Effect', 'aro'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'width_box_effect',
            [
                'label' => esc_html__( 'Width Box Effect', 'aro' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background Color Hover', 'aro'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="elementor-icon-counter">
                <?php if ('use_image' === $settings['icon_select'] && !empty($settings['image']['url'])) :
                    ...
                    if ($path_parts['extension'] === 'svg') {
                        ...
                        $image_html = aro_get_icon_svg($pathSvg);
                    }
...
$widgets_manager->register(new Aro_Elementor_Counter());
