...
if (!class_exists('Aro_Elementor_Control')) :

    /**
     * The Aro Elementor Integration class
     */
    class Aro_Elementor_Control {
        ...
        private function register_control() {
            require get_theme_file_path('inc/elementor/elementor-control/class-product-control.php');
...
return new Aro_Elementor_Control();
