...
add_action( 'elementor/element/icon-list/section_text_style/before_section_end', function ($element, $args ) {
    ...
    $element->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .elementor-icon-list-item .elementor-icon-list-text:before' => 'background-color: {{VALUE}};',
            ],
        ]
    );
...
add_action( 'elementor/element/icon-list/section_icon_style/before_section_end', function ( $element, $args ) {
    $element->add_control(
        'icon_height',
        [
            'label' => esc_html__( 'Line Height', 'aro' ),
...
add_action( 'elementor/element/icon-list/section_icon/before_section_end', function ( $element, $args ) {
    ...
    $element->add_control(
        ...
        [
            ...
            'default' => '',
            'prefix_class' => 'icon-list-style-aro-',
        ]
    );
