...
add_action('elementor/element/image-box/section_image/before_section_end', function ($element, $args) {
    ...
    $element->add_control(
        'image_show_button',
        [
            'label' => esc_html__('Show Button', 'aro'),
    ...
    $element->add_control(
        'image_button_text',
        [
            'label'       => esc_html__('Button Text', 'aro'),
            'type'        => Controls_Manager::TEXT,
            'label_block' => true,
            'placeholder' => esc_html__('Button', 'aro'),
            'default'     => esc_html__('Button', 'aro'),
            'condition'   => [
...
class Aro_Elementor_Image_Box extends Widget_Image_Box {
...
<i class="aro-icon-arrow_s"></i></span></a></div>');
                }
            }
...
$widgets_manager->register(new Aro_Elementor_Image_Box());
