<?php
/**
 * Aro_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Aro_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Aro_Product_Brand_List_Walker', false)) :

	class Aro_Product_Brand_List_Walker extends Walker {
		...
		public function start_el(&$output, $cat, $depth = 0, $args = array(), $current_object_id = 0) {
			...
			if ($args['show_logo']) {
				...
				$output     .= '<img class="product-brand-logo" src="' . esc_url_raw($image_logo[0]) . '" alt="' . esc_attr($cat->name) . '"  title="' . esc_attr($cat->name) . '">';
			} else {
