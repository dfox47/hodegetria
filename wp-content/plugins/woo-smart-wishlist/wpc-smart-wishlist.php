		...
		if ( ! class_exists( 'WPCleverWoosw' ) ) {
			class WPCleverWoosw {
				...
				function __construct() {
					...
					// fragments
					add_action( 'wp_ajax_woosw_get_data', [ $this, 'get_data' ] );
					add_action( 'wp_ajax_nopriv_woosw_get_data', [ $this, 'get_data' ] );
								...
								<form method="post" action="options.php">
									<table class="form-table">
										...
										<tr class="heading">
											...
											<td>
												<span class="description" style="color: #c9356e">This feature is only available on the Premium Version. Click <a href="https://wpclever.net/downloads/smart-wishlist?utm_source=pro&utm_medium=woosw&utm_campaign=wporg" target="_blank">here</a> to buy, just $29.</span>
											</td>
										</tr>
										<tr>
				...
				function admin_enqueue_scripts() {
					...
					wp_enqueue_style( 'woosw-icons', WOOSW_URI . 'assets/css/icons.css', [], WOOSW_VERSION );
					wp_enqueue_style( 'woosw-backend', WOOSW_URI . 'assets/css/backend.css', [], WOOSW_VERSION );
